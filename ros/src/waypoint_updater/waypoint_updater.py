...
class WaypointUpdater(object):
    ...
    def get_cte(self, idx, x0, y0):
        ''' Simple linear approximation to the cross track error'''
    ...
    def pose_cb(self, msg):
        ...
        # a PID controller. (Perhaps more investigation into PID parameter
        # values could yield a better controller)
    ...
    def publish(self, idx):
        ...
        # Dead nuts simple braking strategy.  This strategy depends on
        # the behavior of the controllers, so if that changes, might have
        # to change this too.
